            ...
            interaction.options.data.forEach(option => {
                switch (option.type) {
                    ...
                    case "SUB_COMMAND_GROUP": {
                        ...
                        convertedOptions['options'] = options;
                        break;
                    }
                }
